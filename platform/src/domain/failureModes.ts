...
export type FailureModeDefinitionMapping = Record<string, FailureModeDefinition>

export const FAILURE_MODE_DEFINITION_MAPPING: FailureModeDefinitionMapping = {
  '1.1.1': {
