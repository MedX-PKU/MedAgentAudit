...
def build_open_coding_prompts(item: Dict[str, Any], mas: str) -> Tuple[Dict[str, Any], Dict[str, Any]]:
    ...
    elif mas.lower() == 'medagents':
        mas_description = (
            "MedAgents operates on a consensus-driven, multi-stage collaboration framework: "
...
def main():
    ...
    parser.add_argument("--mas", type=str, required=True, help="Specify the multi-agent system name, like ColaCare, MAC, HealthcareAgent, MDAgents, MedAgents, Reconcile")
